...
if __name__ == "__main__":
    ...
    parser.add_argument("--qwen25_vl_7b_model_path", type=str, default='/mnt/hwfile/smart_science/sunhaoran/Model/Qwen2.5-VL-7B-Instruct', required=True, help="Path to Qwen25-VL 7B model")
    parser.add_argument("--qwen2_vl_7b_model_path", type=str, default='/mnt/hwfile/smart_science/sunhaoran/Model/Qwen2-VL-7B-Instruct', required=True, help="Path to Qwen2-VL 7B model")
    ...
    parser.add_argument("--openai_api_key", type=str, default="sk-Bal815a7fc887ac7eefd144d59029530fd84f4de6e7vnUb3" ,required=True) 
    parser.add_argument("--openai_base_url", type=str, default='https://api.gptsapi.net/v1' ,required=True)
    parser.add_argument("--qwen_api_key", type=str, default="sk-b639c6b0db4c4faf81ce919d37917240" ,required=True) 
    parser.add_argument("--qwen_base_url", type=str, default='https://dashscope.aliyuncs.com/compatible-mode/v1' ,required=True)
    parser.add_argument("--gemini_api_key", type=str, default="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" ,required=True) 
    parser.add_argument("--gemini_base_url", type=str, default='https://openrouter.ai/api/v1' ,required=True)
    parser.add_argument("--ds_api_key", type=str, default="sk-b5939300990144c9b2598206ec88c701" ,required=True) 
    parser.add_argument("--ds_base_url", type=str, default='https://api.deepseek.com' ,required=True)
