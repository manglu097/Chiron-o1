...
if __name__ == "__main__":
    ...
    args_dict = {
        # 数据路径相关参数
        'data_path': '../rp_stage3_data/d2d_qa_plan_a.jsonl',  
        'image_dir_path': '../rp_stage3_data/images',      
        'output_path': '../output/tsis_results_d2d_mov3.jsonl',     
        'num_chunks': 1,                                  
        'chunk_idx': 0,                                   
        ...
        # OpenAI 相关参数
        'openai_api_key': 'sk-Dt20d65da875c82260e771305141f845bec3cdbf664qVOKi',                 
        'openai_base_url': 'https://api.gptsapi.net/v1',                                   
        'qwen_api_key': 'sk-b639c6b0db4c4faf81ce919d37917240',                        
        'qwen_base_url': 'https://dashscope.aliyuncs.com/compatible-mode/v1',
        'ds_api_key': 'sk-70454ee846d54fb898094bb41fbb866b',                        
        'ds_base_url': 'https://api.deepseek.com',
    
        # 教师-学生搜索相关参数
        'teacher_models': ['chatgpt-4o-latest'],          #  , 'google/gemini-2.5-pro-preview-03-25' 'qwen2.5-vl-72b-instruct'           # 教师模型名称列表
